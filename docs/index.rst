...
- Shotgun Data model deriving from :class:`~PySide.QtGui.QStandardItemModel` which makes 
  it easy to quickly build responsive, rich applications with data from your Shotgun site.
